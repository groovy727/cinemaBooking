...
div.seatCharts-cell {color: #182C4E;height: 50px;width: 100px;line-height: 25px;margin: 3px;margin-left:10px;float: left;text-align: center;outline: none;font-size: 13px;} 
div.seatCharts-seat {color: #fff;cursor: pointer;-webkit-border-radius:5px;-moz-border-radius:5px;border-radius: 5px;} 
div.seatCharts-row {height: 50px; width: 100%; margin-left:40px; margin-top:300px;} 
