...
<center>
	  <input type="submit" class="btn btn-default" style="background:#284761;color:#FFFFFF" id="save1"  value="Login as Admin" name="login" />
    </form>    
...
$(document).ready(function(){
	...
	{//	alert("fce");
		$("#err").show(500);
 		$("#err").html("<span style='color:red'>Please enter  all details</span>");
	}
	else
	{
//alert("vdss");
